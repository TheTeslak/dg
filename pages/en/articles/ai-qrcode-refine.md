...
> **Update**: New blog posts - [**Stable Diffusion QR Code 101**](/articles/ai-qrcode-101)

Last week, I wrote a [blog post](/articles/ai-qrcode) about how I learned to generate scannable QR Codes. When doing so, I consider my goal is to find an image that looks like a QR Code as little as possible to humans, but still be recognizable by the machine.
...
Now we have the QR Code, we could move up to generate those images with Stable Diffusion and ControlNet. For detailed steps, please refer to [my previous blog post](/articles/ai-qrcode).
