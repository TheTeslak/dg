...
- [Stylistic QR Code with Stable Diffusion](/articles/ai-qrcode) - by Anthony Fu
- [Refining AI Generated QR Code](/articles/ai-qrcode-refine) - by Anthony Fu
...
Read more about it in [this post](/articles/ai-qrcode-refine).
...
You can refer to [this post](/articles/ai-qrcode-refine#generating-the-base-qr-code) to see a comparison of how different QR Code input affects the output.
...
If you are interested in contributing to this post, fixing typos, or adding new ideas, you can [edit this page on GitHub](https://github.com/antfu/antfu.me/edit/main/pages/articles/ai-qrcode-101.md). Or if you are not familiar with Git, you can also go to [Anthony's Discord server](https://chat.antfu.me) and discuss with us.
