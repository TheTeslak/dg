...
> 感谢印记中文的 [QC-L](https://github.com/QC-L) 对本文进行翻译，英文原文: [English Version](/articles/reimagine-atomic-css)。
...
[属性化模式 (Attributify Mode)](https://windicss.org/articles/v30.html#attributify-mode) 是 Windi CSS 最受欢迎的特性之一。它能帮助你通过使用属性更好地组织和分组你的实用工具类。
...
如果你读过我之前的文章 [Journey with Icons Continues](/articles/journey-with-icons-continues)，你一定知道我对图标非常热衷，并且在积极研究图标的各种解决方案。这次，凭借 UnoCSS 的灵活性，我们甚至可以拥有纯 CSS 的图标。你没看错，**它是纯 CSS 的图标，不需要任何 JavaScript**！让我们来看看它长什么样子：
